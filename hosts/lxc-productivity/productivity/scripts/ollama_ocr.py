...
hyperion_mac = "XX:XX:XX:XX:XX:XX"  # Replace with Hyperion's MAC  addy
...
ollama_payload = {
    "model": "qwen3-vl:8b",
    "prompt": "Transcribe the handwritten text perfectly. Output only the text.",
    "images": [b64_image],
    "stream": False,
}
...
requests.patch(
    ...
    headers=headers,
    json={"content": response.get("response", "")},
)
